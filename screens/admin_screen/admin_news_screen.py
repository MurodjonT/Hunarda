...
class NewsPageScreen(Screen):
    ...
    input_description_news = (By.XPATH, '//*[@data-placeholder="Enter information"]')
    ...
    add_news_path = (By.XPATH, '//*[text() = "test_news"]')
    ...
    edit_news_path = (By.XPATH, '//*[text() = "test_news_edit"]')
    ...
    def check_add_news(self, name_news, description, file):
        ...
        try:
            if self.is_visible(self.add_news_path):
                return True
        except Exception:
            pass
